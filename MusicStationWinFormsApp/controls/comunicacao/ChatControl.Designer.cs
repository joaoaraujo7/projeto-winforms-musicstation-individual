...
        private void InitializeComponent()
        {
            ...
            // tbcChats
            // 
            tbcChats.Controls.Add(tbpListagem);
            tbcChats.Controls.Add(tbpCadastro);
            tbcChats.Dock = DockStyle.Fill;
            tbcChats.Font = new Font("Segoe UI", 10F);
            tbcChats.ItemSize = new Size(64, 0);
            tbcChats.Location = new Point(0, 0);
            tbcChats.Name = "tbcChats";
            tbcChats.SelectedIndex = 0;
            tbcChats.Size = new Size(744, 511);
            tbcChats.TabIndex = 10;
            // 
            // ChatControl
            // 
            AutoScaleDimensions = new SizeF(7F, 15F);
            AutoScaleMode = AutoScaleMode.Font;
            Controls.Add(tbcChats);
            Name = "ChatControl";
