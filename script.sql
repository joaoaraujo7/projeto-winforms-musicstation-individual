...
VALUES
('Jo�o Lima', 'joao@gmail.com', 'joao', 'hash123', '2025-10-10'),
...
('Patr�cia Alves', 'paty@gmail.com', 'paty', 'hash890', '2025-10-10'),
...
(4, '(11)93333-3333', 'Av. das Na��es', '200'),
...
(14, '5', '2025-10-01', 'Acesso a relat�rios e suporte'); 
...
VALUES
('Luthier', 'Constr�i, repara e mant�m instrumentos de cordas.'),
('T�cnico de Som', 'Monta e opera sistemas de �udio.'),
('Professor de Viol�o', 'Ensina t�cnicas, teoria e pr�tica musical.');

-- 7. TABELA SERVICOS
CREATE TABLE Servicos (
� � id_servico INT IDENTITY(1,1) PRIMARY KEY,
� � nome VARCHAR(100) NOT NULL UNIQUE, -- CADA SERVI�O SER� �NICO
...
('Ajuste de Mesa de Som', 'Limpeza e calibra��o de canais', 200.00),
('Aula de Viol�o', 'Inicia��o para iniciantes', 120.00),
('Troca de Cordas', 'Substitui��o de cordas antigas', 80.00),
('Manuten��o de Amplificador', 'Troca de v�lvulas e limpeza', 250.00),
('Aula Avan�ada de Viol�o', 'T�cnicas de solo e harmonia', 130.00),
('Regulagem de Baixo', 'Ajuste de a��o e oitava', 180.00),
('Instala��o de Sistema de Som', 'Montagem completa para eventos', 500.00);
...
� � status VARCHAR(50) NOT NULL
		CHECK (status IN ('Pendente', 'Em andamento', 'Conclu�do', 'Cancelado')),
� � FOREIGN KEY (cliente_id) REFERENCES Clientes(id_cliente)
);

INSERT INTO Pedidos (cliente_id, data_pedido, total, status)
VALUES
(1, '2025-11-12', 270.00, 'Conclu�do'),
(2, '2025-11-10', 200.00, 'Conclu�do'),
(3, '2025-11-08', 120.00, 'Em andamento'),
(4, '2025-11-05', 80.00, 'Conclu�do'),
(5, '2025-11-01', 250.00, 'Conclu�do'),
(6, '2025-11-02', 130.00, 'Conclu�do'),
(7, '2025-11-07', 180.00, 'Em andamento'),
(8, '2025-11-11', 500.00, 'Conclu�do');
...
(2, 'Servi�o conclu�do', 'Seu pedido foi finalizado com sucesso.', 'sistema', '2025-11-10 10:00:00', 1),
(3, 'Novo agendamento', 'Seu servi�o est� em andamento.', 'agendamento', '2025-11-08 12:00:00', 0),
(4, 'Nova mensagem', 'Cliente enviou uma d�vida sobre o servi�o.', 'mensagem', '2025-11-09 14:30:00', 0);
...
VALUES
(1, 1, 1, 150.00), -- Pedido 1 (Jo�o)
(1, 3, 3, 120.00), -- Pedido 1 (Jo�o)
...
(8, 8, 2, 500.00); -- Pedido 8 (Patr�cia)

-- 12. TABELA AVALIACOES
CREATE TABLE Avaliacoes (
� � id_avaliacao INT IDENTITY(1,1) PRIMARY KEY,
� � servico_pedido_id INT NOT NULL UNIQUE, -- Uma avalia��o por item de servi�o/pedido
� � cliente_id INT NOT NULL,
...
VALUES
(1, 1, 5, 'Servi�o excelente!', '2025-11-12'),
(2, 2, 4, 'Bom atendimento!', '2025-11-10'),
(3, 3, 5, 'Excelente aula!', '2025-11-08'), 
(4, 4, 5, 'Muito r�pido!', '2025-11-05'),
(5, 5, 4, 'Som ficou �timo!', '2025-11-01'),
(6, 6, 5, 'Servi�o impec�vel!', '2025-11-02');
...
VALUES
(12, 'Music Station Studio', 'Music Station LTDA', '12.345.678/0001-90', 'contato@musicstation.com', '(11)99999-0000', 'Est�dio e loja de instrumentos musicais.', '2025-08-01');
...
VALUES
(1, 'Guitarra Fender Stratocaster', 'Modelo cl�ssico, �timo som limpo.', 120.00, 1), -- (1 = dispon�vel) (0 = ocupado)
(1, 'Baixo Yamaha TRBX', 'Timbre balanceado, ideal para est�dio.', 100.00, 1), 
(1, 'Teclado Roland', 'Equipamento profissional com v�rias oitavas.', 150.00, 1); 
...
� � status VARCHAR(50) NOT NULL
		CHECK (status IN ('ativa', 'conclu�da', 'atrasada', 'cancelada')),
� � FOREIGN KEY (cliente_id) REFERENCES Clientes(id_cliente)
);
...
VALUES
(1, '2025-11-01', '2025-11-03', 240.00, 'conclu�da'),
(2, '2025-11-05', '2025-11-07', 200.00, 'conclu�da'),
(3, '2025-11-10', '2025-11-15', 750.00, 'ativa');

-- 16. TABELA LOCACAO_ITENS (Detalhe da Loca��o)
...
� � subtotal DECIMAL(10,2) NOT NULL,
    UNIQUE (locacao_id, instrumento_id), -- N�o permite o mesmo item ser locado duas vezes no mesmo pedido
...
-- 18. TABELA TRANSACOES_PAGAMENTO -- registra o processo t�cnico da comunica��o com o sistema de pagamento.
...
VALUES
(1, 1, 'Ol�, preciso de conserto r�pido.', '2025-11-10 08:05:00', 1),
(1, 9, 'Claro, posso agendar para amanh�.', '2025-11-10 08:06:00', 1),
(2, 3, 'Quando posso ter aula de viol�o?', '2025-11-08 09:31:00', 0),
(3, 10, 'A manuten��o ficou pronta!', '2025-11-01 12:10:00', 1);
...
(2, 2), -- Paulo Bezerra (T�cnico de Som)
(3, 3); -- Ana Paula (Professor de Viol�o)
